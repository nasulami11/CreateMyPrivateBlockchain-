...
(function theLoop(i){
  setTimeout( function(){
    ...
    setTimeout(() => console.log('validate blockchain'),1000 );
    setTimeout(() => myBlockChain.validateChain(),3000 )

//myBlockChain.getBlockHeight();
//myBlockChain.getBlock(0)
//myBlockChain.getBlock(10)
//myBlockChain.addBlock(new Block('blockTest'));
//db.getBlocksCount();
//myBlockChain.getBlockHeight();